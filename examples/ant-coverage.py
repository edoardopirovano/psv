...
print("\t")
print("\tupdate")
print("\t\t(move, xCoord<" + str(n-1) + ", {}) -> (xCoord'=xCoord+1) & (state'=0);")
...
for x in range(0,n):
	for y in range(0,n):
		print("\t\t(visit" + str(x) + str(y) + ", true, {}) -> 1.0:(state'=1);")
		
print("\t\t")

for x in range(0,n):
	for y in range(0,n):
		print("\t\t(observe, xCoord=" + str(x) + " & yCoord=" + str(y) + ", {}) -> 1.0:"
...
for x in range(0,n):
	for y in range(0,n):
		if (sys.argv[2] == "nc"):
			print("\t\t(true, {visit" + str(x) + str(y) + "}) -> 1.0:(uValue" + str(x) + str(y) + "'=uValue" + str(x) + str(y) + "+1);")
		if (sys.argv[2] == "lrta"):
			print("\t\t(true, {visit" + str(x) + str(y) + "}) -> 1.0:(uValue" + str(x) + str(y) + "'=floor(min(" +
