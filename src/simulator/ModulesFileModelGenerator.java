...
public class ModulesFileModelGenerator extends DefaultModelGenerator implements CSGModelGenerator
{
	...
	/*** ***/
	protected Map<Integer, BitSet> synchMap;
	/*** ***/
	...
	public double getStateActionReward(int r, State state, Object action) throws PrismException
	{
		...
		if(rewStr instanceof SRewardStruct) {
			Set<String> csgActions = ((HashSet<String>) action);;
	...
	private TransitionList getTransitionList() throws PrismException
	{
		...
		if (!transitionListBuilt) {
			if(modelType == ModelType.CSG) {
				updater.calculateTransitionsCSG(exploreState, transitionList, synchMap);
			}
			else {
	...
	/*** Getters and setters for CSG ***/
	public Map<Integer,BitSet> getSynchMap() {
		return this.synchMap;
	}
	
	public void addToSynchMap(BitSet b, int i) {
		this.synchMap.put(i, (BitSet) b.clone());
	}
	/*** ***/
}
