...
public class ChoiceListFlexi implements Choice
{
	...
	public ChoiceListFlexi(ChoiceListFlexi ch)
	{
		...
		/*** ***/
		productID = ch.getProductID();
		product = (BitSet) ch.getProduct().clone();
		/*** ***/
	}
	...
	public void addSynchToProduct(int i) {
		this.product.set(i);
	}
	public void setProduct(BitSet b) {
		this.product = (BitSet) b.clone();
	}
	/*** ***/
