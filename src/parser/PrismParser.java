...
public class PrismParser implements PrismParserConstants {
        ...
        public SyncSwarmFile parseSyncSwarmFile(InputStream str) throws PrismLangException
        {
                SyncSwarmFile sf = null;
        ...
        public AsyncSwarmFile parseAsyncSwarmFile(InputStream str) throws PrismLangException
        {
                AsyncSwarmFile sf = null;
        ...
        public FaultFile parseFaultFile(InputStream str) throws PrismLangException
        {
                FaultFile ff = null;
...
// Asynchronous swarm file
  static final public AsyncSwarmFile AsyncSwarmFile() throws ParseException, PrismLangException {
    ActionTypes acts = null;
    Module agent = null;
    List<Module> agents = new ArrayList<Module>();
    Module e = null;
        AsyncSwarmFile sf = new AsyncSwarmFile();
        Token begin = null;
            begin = getToken(1);
    acts = ActionTypes();
    label_1:
    ...
    while (true) {
      ...
      LabelDef(sf.getLabelList());
    }
    jj_consume_token(0);
            sf.setActionTypes(acts);
                sf.setAgents(agents);
                sf.setEnvironment(e);
                sf.setPosition(begin != null? begin: getToken(0), getToken(0));
                {if (true) return sf;}
    throw new Error("Missing return statement in function");
  }

// Synchronous swarm file
  static final public SyncSwarmFile SyncSwarmFile() throws ParseException, PrismLangException {
        Agent agent = null;
    List<Agent> agents = new ArrayList<Agent>();
    Agent e = null;
        SyncSwarmFile sf = new SyncSwarmFile();
        Token begin = null;
            begin = getToken(1);
    label_3:
    while (true) {
...
// Fault file
  static final public Fault Fault() throws ParseException, PrismLangException {
        String command;
        Expression guard;
        Updates updates;
        Fault f = new Fault();
    ...
    jj_consume_token(SEMICOLON);
            ...
            f.setGuard(guard);
            f.setUpdates(updates);
                {if (true) return f;}
    throw new Error("Missing return statement in function");
  }

// Fault file
  static final public FaultFile FaultFile() throws ParseException, PrismLangException {
        List<List<Fault>> faults = new ArrayList<List<Fault>>();
        List<Fault> faultList = new ArrayList<Fault>();
        Fault fault;
        FaultFile ff = new FaultFile();
        Token begin = null;
            begin = getToken(1);
    label_5:
    while (true) {
  ...
  static final public ActionTypes ActionTypes() throws ParseException, PrismLangException {
    ActionTypes acts = new ActionTypes();
    String act = null;
    HashSet<String> a = new HashSet<String>();
    HashSet<String> ae = new HashSet<String>();
    HashSet<String> gs = new HashSet<String>();
        Token begin = null;
    begin = jj_consume_token(ASYNC);
    jj_consume_token(EQ);
    ...
    jj_consume_token(RBRACE);
        ...
        acts.setAe(ae);
        acts.setGs(gs);
                acts.setPosition(begin != null? begin: getToken(0), getToken(0));
                {if (true) return acts;}
    throw new Error("Missing return statement in function");
  }

// Agent description
  static final public Agent Agent() throws ParseException {
        Agent agent = new Agent();
        Declaration var = null;
        Action action = null;
        AgentUpdate agentUpdate = null;
        Token begin = null;
    begin = jj_consume_token(AGENT);
    label_10:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case REG_IDENT:
    ...
    while (true) {
      ...
      agentUpdate = AgentUpdate();
                                        agent.addUpdate(agentUpdate);
    }
    jj_consume_token(ENDUPDATE);
    jj_consume_token(ENDAGENT);
          agent.setPosition(begin, getToken(0)); {if (true) return agent;}
    throw new Error("Missing return statement in function");
  }
...
// Agent action
  static final public Action Action() throws ParseException {
    ...
    condition = Expression(false, false);
    jj_consume_token(SEMICOLON);
      action = new Action(name, condition); action.setPosition(begin, getToken(0)); {if (true) return action;}
    throw new Error("Missing return statement in function");
  }

// Agent update
  static final public AgentUpdate AgentUpdate() throws ParseException {
        AgentUpdate agentUpdate = new AgentUpdate();
        String actionName = null;
        Expression stateCondition = null;
        String act = null;
    ...
    jj_consume_token(COMMA);
    stateCondition = Expression(false, false);
    jj_consume_token(COMMA);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NOT:
    case EQ:
      ...
      case EQ:
        jj_consume_token(EQ);
                agentUpdate.setInclusionType(AgentUpdate.EQ);
        break;
      case NOT:
        jj_consume_token(NOT);
                                                                         agentUpdate.setInclusionType(AgentUpdate.NOTIN);
        break;
      default:
        jj_la1[15] = jj_gen;
        jj_consume_token(-1);
    ...
    jj_consume_token(RARROW);
    updates = Updates();
                                                           agentUpdate.setUpdates(updates);
    jj_consume_token(SEMICOLON);
          agentUpdate.setPosition(begin, getToken(0));
        agentUpdate.setActionName(actionName);
        agentUpdate.setStateCondition(stateCondition);
        agentUpdate.setUpdates(updates); {if (true) return agentUpdate;}
    throw new Error("Missing return statement in function");
  }

// Environment description
  static final public Agent Environment() throws ParseException {
        Agent environment = new Agent();
        Declaration var = null;
        Action action = null;
        AgentUpdate agentUpdate = null;
        Token begin = null;
    begin = jj_consume_token(ENVIRONMENT);
    label_14:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case REG_IDENT:
      ...
      var = Declaration();
                                environment.addDeclaration(var);
    }
    label_15:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    ...
    while (true) {
      ...
      agentUpdate = AgentUpdate();
                                        environment.addUpdate(agentUpdate);
    }
    jj_consume_token(ENDUPDATE);
    jj_consume_token(ENDENVIRONMENT);
          environment.setPosition(begin, getToken(0)); {if (true) return environment;}
    throw new Error("Missing return statement in function");
  }
...
// Synch Module
  static final public SModule SModule() throws ParseException {
        ExpressionIdent name = null;
        Declaration var = null;
        Command comm = null;
        SModule module = null;
        Token begin = null;
    begin = jj_consume_token(SMODULE);
    name = IdentifierExpression();
                                                          module = new SModule(name.getName());
    label_24:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case REG_IDENT:
  ...
  static final public Command Command() throws ParseException {
    ...
    case REG_IDENT:
      ...
      case QMARK:
        ...
        case NOT:
          jj_consume_token(NOT);
                         comm.setSynchType(Command.ActionType.OUTPUT);
          break;
        case QMARK:
          jj_consume_token(QMARK);
                           comm.setSynchType(Command.ActionType.INPUT);
          break;
        default:
          jj_la1[47] = jj_gen;
          jj_consume_token(-1);
...
// Multiple Synch Command
  static final public Command SCommand() throws ParseException {
        String synch = null;
        Expression guard = null;
        Updates updates = null;
        SCommand comm = new SCommand();
        Token begin = null;
    // Synchronisation action-label
            begin = jj_consume_token(LBRACKET);
    synch = Identifier();
...
// Bimatrix Reward Structure
  static final public SRewardStruct SRewardStruct() throws ParseException {
        String name = null, s = null;
        List<String> ls = null;
        Expression guard = null, value = null;
        SRewardStruct rs = new SRewardStruct();
        SRewardStructItem rsi;
        Token begin = null, begin2 = null;
    begin = jj_consume_token(SREWARDS);
    ...
    while (true) {
      ...
      default:
        ...
        break label_30;
            ...
            begin2 = getToken(1); s = null; ls = new ArrayList<String>();
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case LBRACKET:
        jj_consume_token(LBRACKET);
                             s = "";
      ...
      jj_consume_token(SEMICOLON);
          rsi = new SRewardStructItem(ls, guard, value); rsi.setPosition(begin2, getToken(0)); rs.addItem(rsi);
    }
    jj_consume_token(ENDSREWARDS);
...
// Basic expression (top of operator precedence ordering)
  static final public Expression ExpressionBasic(boolean prop, boolean pathprop) throws ParseException {
    ...
    case R:
      ...
      break;
    case N:
      ret = ExpressionNash(prop, pathprop);
      break;
    case E:
...
// (Property) expression for the Nash operator
  static final public Expression ExpressionNashProb(boolean prop, boolean pathprop) throws ParseException {
        ExpressionNashProb ret = new ExpressionNashProb();
        Expression expr1;
        Expression expr2;
        Token begin;
    ...
    jj_consume_token(LBRACKET);
    expr1 = Expression(prop, true);
    jj_consume_token(COMMA);
    expr2 = Expression(prop, true);
    jj_consume_token(RBRACKET);
                ret.setExpression1(expr1);
                ret.setExpression2(expr2);
...
// (Property) expression: Nash operator N
  static final public Expression ExpressionNash(boolean prop, boolean pathprop) throws ParseException {
        Expression expr;
        Expression rew = null;
        ExpressionNash ret = new ExpressionNash();
        String relOp = null;
        boolean isBool;
        int r;
        Token begin;
    ...
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case P:
      expr = ExpressionNashProb(prop, pathprop);
      break;
    case R:
      expr = ExpressionNashReward(prop, pathprop);
      break;
    default:
      jj_la1[116] = jj_gen;
      jj_consume_token(-1);
...
// (Reward) structure index for N operator
  static final public void NashRewardIndexes(ExpressionNashReward exprNash) throws ParseException {
        Object idx1 = null;
        Object idx2 = null;
    jj_consume_token(LBRACE);
    ...
    jj_consume_token(RBRACE);
                exprNash.setRewardStructIndex1(idx1);
                exprNash.setRewardStructIndex2(idx2);
  }

// (Reward) expression for Nash operator
  static final public Expression ExpressionNashReward(boolean prop, boolean pathprop) throws ParseException {
        ExpressionNashReward ret = new ExpressionNashReward();
        Expression expr1;
        Expression expr2;
        Token begin;
          if (!prop) {if (true) throw generateParseException();}
    ...
    jj_consume_token(LBRACKET);
    expr1 = ExpressionRewardContents(prop, pathprop);
    jj_consume_token(COMMA);
    expr2 = ExpressionRewardContents(prop, pathprop);
    jj_consume_token(RBRACKET);
                ret.setExpression1(expr1);
                ret.setExpression2(expr2);
                ret.setPosition(begin, getToken(0));
  ...
  static final public Expression ExpressionStrategy(boolean prop, boolean pathprop) throws ParseException {
    ...
    case N:
      ...
      case R:
        ...
        break;
      case N:
        expr = ExpressionNash(prop,pathprop);
        break;
      default:
        jj_la1[134] = jj_gen;
        jj_consume_token(-1);
...
// For loop
  ...
  static final private int[] jj_la1 = new int[147];
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x10,0x0,0x10,0x0,0x10,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40023c00,0x40023c00,0x0,0xa0040408,0x0,0xa0040408,0xa0040408,0x0,0xa0040408,0x20000,0x0,0x1000,0x23800,0x10100,0x10100,0x0,0x400,0x0,0x0,0x300,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xa0040008,0x0,0x0,0x0,0xa0040008,0x0,0x0,0xa0040008,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xa0040008,0xa0040008,0xa0040008,0xa0040008,0xa0040008,0x0,0x0,0x0,0x0,0x0,0x0,0xa0040008,0x0,0x0,0x0,0x0,0x0,0x0,0xa0040008,0xa0040008,0x0,0x0,0x0,0x0,0x20000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xa0040008,0xa0040008,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xa0048008,0x0,0xa0040008,0x0,0x0,0xa0044008,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x400,0x0,0x400,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf0144450,0xe0104410,0x10040040,0x4fe22401,0x0,0x4fe22401,0x4fe22401,0x0,0x4fe22401,0x20000000,0x104000,0x0,0xa0104000,0x200,0x200,0x40000000,0x40000000,0x0,0x40,0x200,0x0,0x80,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xfea2023,0x0,0x0,0x0,0xfea2023,0x0,0x0,0xfea2023,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80022,0x0,0xfea2023,0xfea2023,0xfea2023,0xfea2023,0xfea2023,0x0,0x0,0x0,0x0,0x0,0x0,0xfe22001,0x0,0x0,0x0,0x0,0x0,0x0,0xfe22001,0xfe22001,0x0,0x22000,0x22000,0x0,0x0,0x0,0x22000,0x22000,0x3b800,0xfe00000,0x0,0x0,0x22000,0x0,0x0,0x0,0x22000,0x22000,0x3b800,0x0,0x8000000,0xfea2023,0xfea2023,0x0,0x0,0x0,0x22000,0x22000,0x3b800,0x0,0x0,0xfea2023,0x0,0xfea2023,0x0,0x0,0xfea212f,0x0,0xfe00000,0xfe00000,0x0,0x0,0x0,0x0,0x40,0x22000,0x0,0x22000,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000000,0x2000000,0x0,0x0,0x0,0x0,0x0,0xa1e003,0xe001,0xa10002,0x20219fd,0x0,0x20219fd,0x20219fd,0x0,0x20219fd,0x0,0x0,0x2000,0xe000,0x0,0x0,0x1,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000000,0x2000000,0x0,0x0,0x0,0x20219fc,0x4000000,0x20000,0x0,0x20219fc,0x0,0x0,0x20219fc,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x140100,0x0,0x140100,0x0,0x0,0x20219fc,0x20219fc,0x20219fc,0x20219fc,0x20219fc,0x0,0x0,0x10000000,0x20000000,0x8000000,0x4000000,0x20219fc,0x0,0x0,0x0,0x0,0x0,0x0,0x219fc,0x219fc,0x0,0x0,0x0,0x0,0x20000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x8fc,0x100,0x20219fc,0x20219fc,0x0,0x0,0x0,0x0,0x0,0x0,0x1fc,0x0,0x20219fc,0x0,0x20219fc,0x0,0x1000,0x20219fc,0x0,0x9fc,0x9fc,0x0,0x0,0x0,0x0,0x0,0xc000000,0x0,0x0,0x0,0x0,0x80000000,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x8,0x2,0x80000000,0x2,0x80000000,0x2,0x80000000,0x80000000,0x20,0x8,0x800,0x800,0x80000000,0x2,0x80000000,0x20,0x8,0x0,0x0,0x0,0xb8108088,0x1,0xb8108088,0xb8108088,0x1,0xb8108088,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x800,0x0,0x20,0x80000000,0x0,0x20,0x80000000,0x20,0x4000000,0x4000000,0x80000000,0x2,0x80000,0xb8108088,0x0,0x8,0x2,0xb81080a8,0x2,0x20,0xb81080a8,0x80000000,0x20,0x2,0x400200,0x2,0x2,0x400200,0x88000008,0x2,0x80000020,0x80000020,0x0,0x66820,0x0,0x0,0x66820,0xb8108088,0xb8108088,0xb8108088,0xb8108088,0xb8108088,0x66820,0x4000000,0x0,0x0,0x0,0x0,0xb8108088,0x1800,0x66000,0x980000,0x980000,0xe00000,0xe00000,0xb8108088,0xb8008088,0x8,0x0,0x80000000,0x2,0x30000000,0x8,0x800,0x800,0x66800,0x0,0x200,0x200,0x0,0x8,0x66808,0x200,0x800,0x800,0x66800,0x0,0x0,0xb8108088,0xb8108088,0x200,0x8,0x200,0x800,0x800,0x66800,0x0,0x200,0xb8108088,0x2,0xb8108088,0x400000,0x0,0xb8108088,0x8080,0x0,0x8,0x2,0x90000000,0x200000,0x90000000,0x80000000,0x80080000,0x2,0x80000000,0x1800,0x66000,0x0,};
   }
