...
public class ASTTraverse implements ASTVisitor
{
	...
	// -----------------------------------------------------------------------------------
	public void visitPre(Agent e) throws PrismLangException {
		defaultVisitPre(e);
	}
	@Override
	public Object visit(Agent e) throws PrismLangException {
		visitPre(e);
		for (Declaration declaration : e.getDecls()) {
			declaration.accept(this);
		}
		for (Action action : e.getActions()) {
			action.accept(this);
		}
		for (AgentUpdate agentUpdate : e.getUpdates()) {
			agentUpdate.accept(this);
		}
		visitPost(e);
		return null;
	}
	public void visitPost(Agent e) throws PrismLangException {
		defaultVisitPost(e);
	}
	// -----------------------------------------------------------------------------------
	public void visitPre(Action e) throws PrismLangException {
		defaultVisitPre(e);
	}
	@Override
	...
	public void visitPost(Action e) throws PrismLangException {
		defaultVisitPost(e);
	}
	// -----------------------------------------------------------------------------------
	public void visitPre(AgentUpdate e) throws PrismLangException {
		defaultVisitPre(e);
	}
	@Override
